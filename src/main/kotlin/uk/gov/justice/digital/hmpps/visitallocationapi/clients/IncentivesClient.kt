...
class IncentivesClient(
  ...
  fun getPrisonerIncentiveReviewHistory(prisonerId: String): PrisonerIncentivesDto {
    ...
    return webClient.get()
      ...
      .block(apiTimeout) ?: throw TimeoutException("Request timed out while fetching prisoner incentive level for prisoner ID $prisonerId")
  }

  fun getPrisonIncentiveLevels(prisonId: String, levelCode: String): PrisonIncentiveAmountsDto {
    ...
    return webClient.get()
      ...
      .block(apiTimeout) ?: throw TimeoutException("Request timed out while fetching incentive level for $prisonId, level $levelCode")
  }
