...
const val ADJUST_VISIT_ORDER_BALANCE = "$PRISONER_ID_PATH/adjust-balance"

@RestController
class BalanceAdjustmentController(private val balanceService: BalanceService) {

  @PreAuthorize("hasRole('$ROLE_VISIT_ALLOCATION_API__VSIP_ORCHESTRATION_API')")
  @PutMapping(ADJUST_VISIT_ORDER_BALANCE)
  @Operation(
  ...
  ) = balanceService.adjustPrisonerBalance(balanceAdjustmentDto)
}
