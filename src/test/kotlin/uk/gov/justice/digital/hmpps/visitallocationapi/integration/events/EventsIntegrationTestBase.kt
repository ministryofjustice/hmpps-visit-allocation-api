...
abstract class EventsIntegrationTestBase {
  ...
  @MockitoSpyBean
  protected lateinit var prisonerAllocationService: PrisonerAllocationService

  @MockitoSpyBean
  protected lateinit var prisonerMergeService: PrisonerMergeService

  @MockitoSpyBean
  protected lateinit var prisonerReceivedResetBalanceService: PrisonerReceivedResetBalanceService

  @MockitoSpyBean
  protected lateinit var prisonerVisitOrderRefundService: PrisonerVisitOrderRefundService

  @MockitoSpyBean
  protected lateinit var prisonerVisitOrderUsageService: PrisonerVisitOrderUsageService
